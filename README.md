# Riothaus realtime Sketch to Code

To get started the following and open the sketch file design/design-spec.sketch and run the following.
```bash
npm start
npm run watch
```
...
Go ahead and edit layer styles in the sketch file and save. Open localhost:3000 and you should see your changes. This should have autogenerated some files in the build directory and it should look like this:
```
├── android/
│   ├── font_dimens.xml
│   ├── colors.xml
...
If you open `config.json` you will see there are 4 platforms defined: scss, android, ios, and js. Each platform has a transformGroup, buildPath, and files. The buildPath and files of the platform should match up to the files what were built. The files built should look like these:
